...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between px-4 py-8 bg-neutral-50 dark:bg-neutral-950">
      ...
      <footer className="text-center pt-4">
        <a
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium text-neutral-500 dark:text-neutral-400 hover:text-primary-600 opacity-80 hover:opacity-100 transition-opacity"
        >
