...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-white dark:bg-neutral-900">
          ...
          <div className="relative z-10 flex flex-col justify-center px-12 lg:px-16">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
              <div className="flex items-center gap-3 mb-8">
                <div className="w-12 h-12 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center text-white font-bold text-xl">Z</div>
                <span className="text-2xl font-bold text-white">Zashub</span>
              </div>
              ...
              <div className="mt-12 grid grid-cols-2 gap-6">
                {[
                  ...
                  { title: 'Discover Events', description: 'Find local gatherings' }, 
        ...
        <div className="flex-1 flex flex-col justify-center px-6 py-12 bg-white dark:bg-neutral-900 overflow-y-auto">
          <div className="w-full max-w-md mx-auto py-8">
            <div className="lg:hidden flex items-center gap-2 mb-8">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-secondary-500 to-primary-600 flex items-center justify-center text-white font-bold">Z</div>
              <span className="text-xl font-bold text-neutral-900 dark:text-white">Zashub</span>
            </div>

            <div className="flex items-center gap-2 mb-8">
              {[1, 2, 3].map((s) => <div key={s} className={cn('flex-1 h-1.5 rounded-full transition-colors duration-300', s <= step ? 'bg-primary-600' : 'bg-neutral-200 dark:bg-neutral-700')} />)}
            </div>
      ...
      {/* Signup Page Footer Badge */}
      <footer className="py-4 text-center border-t border-neutral-100 dark:border-neutral-800/60 bg-neutral-50/50 dark:bg-neutral-900/50">
        <a
          href="https://zashly.com"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium text-neutral-500 dark:text-neutral-400 hover:text-primary-600 dark:hover:text-white opacity-80 hover:opacity-100 transition-all duration-200"
        >
